...
exports.default = MobileMenu; //es6 way of exporting to main app.js file
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.headerLinks = (0, _jquery2.default)(".primary-nav a"); //grabs all a from header
    ...
    value: function createPageSectionWaypoints() {
      ...
      this.pageSections.each(function () {
        ...
        new Waypoint({
          ...
          offset: "18%" //triggers early viewport for quicker fong highlighting
        });
        ...
        new Waypoint({
          ...
          offset: "-40%" //triggers early viewport for quicker fong highlighting
        });
      });
    }
  }]);
